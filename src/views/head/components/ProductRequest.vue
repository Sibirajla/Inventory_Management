...
export default {
  ...
  async mounted() {
    // Fetch user info including department based on email from sessionStorage
    try {
      ...
      if (userData && userData.email) {
        ...
        this.email = userData.email; // Set email from sessionStorage
        this.department = department; // Set department from API response
      } else {
