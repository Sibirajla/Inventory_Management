<template>
  <div class="slidebar">
    <div class="slidebar-brand">
      <h2>
        <span class="las la-cube la-2x logo-icon"></span> <span>BIT INVENTORY</span>
      </h2>
    </div>
    <div class="sliderbar-menu">
      <ul>
        <li :class="{ active: isActive('/dashboard/inventory') }">
          <router-link
            to="/dashboard/inventory"
            @click="setActive('/dashboard/inventory')"
          >
            <span class="las la-igloo"></span><span>Dashboard</span>
          </router-link>
        </li>
        <li :class="{ active: isActive('/dashboard/users') }">
          <router-link to="/dashboard/users" @click="setActive('/dashboard/users')">
            <span class="las la-user"></span><span>Users</span>
          </router-link>
        </li>
        <li :class="{ active: isActive('/dashboard/product') }">
          <router-link to="/dashboard/product" @click="setActive('/dashboard/product')">
            <span class="las la-box"></span><span>Product</span>
          </router-link>
        </li>
        <li :class="{ active: isActive('/dashboard/approval_inventory') }">
          <router-link
            to="/dashboard/approval_inventory"
            @click="setActive('/dashboard/approval_inventory')"
          >
            <span class="las la-thumbs-up"></span><span>Approval</span>
          </router-link>
        </li>
        <li :class="{ active: isActive('/dashboard/transfered_inventory') }">
          <router-link
